const deleteAccOtpTemplate = (otp: string) => (
...
<head>
  ...
  <title>Account Verification - Newsglance</title>
</head>
          ...
          <tr>
            <td style="padding: 30px 24px;">
              ...
              <p style="margin: 0 0 24px 0; font-size: 14px; color: #666666; text-align: center; font-family: Arial, sans-serif;">
                Enter the verification code below to delete your account.
              </p>
...
export default deleteAccOtpTemplate;
